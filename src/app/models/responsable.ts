...
// Esnecesario. algo de refeencias!!!
    public clone():Responsable{
        return new Responsable(this.nombre1,this.nombre2,this.apellido1,this.apellido2,this.pais,this.division,this.subdivision,this.tel_fijo,this.tel_movil,this.id);
    }
